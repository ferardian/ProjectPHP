<?php 
	class indikator3 extends CI_Controller{
		...
		$this->template->load('template_ido','indikator/v_indikator3',$data);
		...
		public function index_analisa(){
			...
			$this->template->load('template_ido','v_analisa3',$data);
		}
		...
		public function post(){
			...
			$this->template->load('template_ido','indikator/post3',$data);	
			}
		...
		public function post_analisa(){
			if (isset($_POST['submit'])){
				...
				redirect('indikator3/index_analisa'); 
			...
			$data['data_indikator'] = $this->indikator_mod->getindikator_ruang($id_ruang_inmut)->result();
			$this->template->load('template_ido','indikator/post_analisa',$data);
			}	
		...
		public function edit(){
			...
			$data['id']= $id;
			$this->template->load('template_ido','indikator/edit3',$data);	
			}
		}
