<?php 
	class rekap_ikp2 extends CI_Controller{
		...
		$data['record']=$ruangan;
		$this->template->load('template_indikator','rekap_ikp/v_rekap_ikp2',$data);
		}
		...
		public function post (){
			...
			$this->template->load('template_indikator','rekap_ikp/post2',$data);	
			}
		...
		public function edit(){
			...
			if(isset($_POST['submit'])){
				...
				$data['id']= $id;
				//print_r($id);
				$this->template->load('template_indikator','rekap_ikp/edit2',$data);
			}
		}
}