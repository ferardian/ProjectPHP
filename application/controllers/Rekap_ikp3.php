<?php 
	class rekap_ikp3 extends CI_Controller{
		...
		$data['record']=$ruangan;
		$this->template->load('template_ido','rekap_ikp/v_rekap_ikp3',$data);
		}
		...
		public function post (){
			...
			$this->template->load('template_ido','rekap_ikp/post3',$data);	
			}
		...
		public function edit(){
			...
			if(isset($_POST['submit'])){
				...
				$data['id']= $id;
				//print_r($id);
				$this->template->load('template_ido','rekap_ikp/edit3',$data);
			}
		}
}