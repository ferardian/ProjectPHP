<?php 
	class Report2 extends CI_Controller{
		...
		function index(){ 
			...
			$this->template->load('template_indikator','v_report2');
		...
		function report_inmut(){ 
			...
			$this->template->load('template_indikator','v_report_inmut2',$data);
			// $this->load->view('template_admin',$data);
		}
		
		function report_ikp(){ 
			
			$this->template->load('template_indikator','v_report_ikp2');
		}
		...
		function post_inmut(){
			...
			return $this->template->load('template_indikator','v_rekap_inmut2',$query);
