              ...
              <div class="box box-primary">
                ...
                <form role="form">
                  <div class="box-body">
                    ...
                    <select required name="kd_inmut" class="form-control select2" style="width: 100%;">
                      <option value="" disable>Indikator Mutu</option>
                    ...
                    <div class="row col-md-12">
                      ...
                      <input type="number" class="form-control"  placeholder="Numerator" name="num" required>
                    </div>
                    </div>
                    <div class="row col-md-12">
                     <div class="form-group">
                      <label >Denumerator</label>
                      <input type="number" class="form-control"  placeholder="Denumerator" name="denum" required>
                    </div>
                    </div>
                  ...
                  <div class="box-footer">
                    ...
                    <?php 
                        echo anchor('Indikator','Kembali',array('class'=>'btn btn-primary btn-sm'));
