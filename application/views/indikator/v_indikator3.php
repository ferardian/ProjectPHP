              ...
              <div class="box">
                <div class="box-header">
                  <div class='row col-md-3'>
                     ...
                     <?php  
                    echo anchor('indikator3/post','Tambah Data',array('class'=>'btn btn-primary btn-sm'));
                    ...
                    <tbody>
                       ...
                       $no=1;
                          foreach ($record as $r){
                            ...
                            print "<td width='10' align='center'>".anchor("indikator3/edit/".$r->id,"<span class='glyphicon glyphicon-edit'></span>",array('title'=>'edit data'));
                            print "<td width='10' align='center'>".anchor("indikator3/delete/".$r->id,"<span class='glyphicon glyphicon-trash'></span>",array('title'=>'hapus data'));
                          $no++;
                        }?>
                    </tbody>
