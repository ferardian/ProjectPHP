<!-- general form elements -->
              <div class="box box-primary">
                ...
                <!-- form start -->
                <?php 
                    echo form_open('rekap_ikp3/edit')
                 ?>
                <form role="form">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  placeholder="Nama Pasien" name="nama_pasien" value="<?php echo $row ['nama_pasien']; ?>" required >
                  ...
                  ?>
                    ...
                    <div class="row col-md-2">
                      ...
                      <input type="number" class="form-control"  placeholder="Senitnel" name="sentinel" value="<?php echo $row ['sentinel']; ?>" >
                    </div>
                    </div>
                    ...
                    <div class="row col-md-2">
                     <div class="form-group">
                      <label >KTD</label>
                      <input type="number" class="form-control"  placeholder="KTD" name="ktd" value="<?php echo $row ['ktd']; ?>" >
                    </div>
                    </div>
                    <div class="row col-md-1">
                    ...
                    <div class="form-group">
                      <label >KNC</label>
                      <input type="number" class="form-control"  placeholder="KNC" name="knc" value="<?php echo $row ['knc']; ?>">
                    </div>
                    </div>
                  <div class="row col-md-1">
                  ...
                  <div class="row col-md-2">
                   <div class="form-group">
                      ...
                      <input type="number" class="form-control"  placeholder="KTC" name="ktc" value="<?php echo $row ['ktc']; ?>">
                    </div>
                    </div>
                    <div class="row col-md-1">
                   ...
                   <div class="form-group">
                      ...
                      <input type="number" class="form-control"  placeholder="KPC" name="kpc" value="<?php echo $row ['kpc']; ?>">
                    </div>
                    </div>
                    <div class="row col-md-1">
                 ...
                 <div class="row col-md-12">
                  <div class="box-footer">
                    ...
                    <?php 
                        echo anchor('rekap_ikp3','Kembali',array('class'=>'btn btn-primary btn-sm'));
