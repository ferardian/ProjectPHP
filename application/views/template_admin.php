      ...
      <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
          ...
          <aside class="main-sidebar">
            ...
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>rekap_ikp/">
            ...
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>report/report_inmut">
                <i class="fa fa-list-ul"></i>
            ...
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>report/report_ikp">
                <i class="fa fa-list-ul"></i>
             ...
             <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>report/daftar_analisa">
                <i class="fa fa-list-ul"></i>
