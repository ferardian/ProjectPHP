        ...
        <div class="wrapper">
          ...
          <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <a href="<?php echo site_url() ?>/indikator3/">
                <i class="fa fa-male"></i>
                <span>Indikator Mutu</span>
              </a>          
            </li>
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/rekap_ikp3/">
                <i class="fa fa-male"></i>
                <span>Rekap Harian IKP</span>
              </a>          
            </li>
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/rekap_ido/">
                <i class="fa fa-male"></i>
                <span>Rekap Harian IDO</span>
              </a>          
            </li>
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/report3/report_inmut/">
                <i class="fa fa-male"></i>
            ...
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/report3/report_ikp/">
                <i class="fa fa-male"></i>
