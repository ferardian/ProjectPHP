        ...
        <div class="wrapper">
          ...
          <header class="main-header">
            ...
            <a href="<?php echo site_url() ?>admin/Dashboard/" class="logo">
              ...
              <span class="logo-mini">RSSK</span>
              <!-- logo for regular state and mobile devices -->
              <span class="logo-lg">RSSK Admin Menu</span>
            </a>
          ...
          <aside class="main-sidebar">
            ...
            <ul class="sidebar-menu">
              ...
              <a href="<?php echo site_url() ?>/indikator/lihat_semua">
             ...
             <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/rekap/lihat_semua">
                <i class="fa fa-male"></i>
                <span>Rekap Harian Infeksi</span>
              </a>          
            </li>
           
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/rekap_ikp/lihat_semua">
                <i class="fa fa-male"></i>
                <span>Rekap Harian IKP</span>
              </a>          
            </li>
             <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/report/index_admin">
                <i class="fa fa-male"></i>
                <span>Report Infeksi Harian</span>
              </a>          
            </li>
            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/report/report_inmut_admin">
                <i class="fa fa-male"></i>
                <span>Report Indikator Mutu</span>
              </a>          
            </li> 

            <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/report/report_ikp_admin">
                <i class="fa fa-male"></i>
                <span>Report IKP</span>
              </a>          
            </li>

             <li class="treeview <?php if (!empty($index)): echo $index; elseif (empty($index)): echo 'noactive'; endif ?>" id="pelamar">
              <a href="<?php echo site_url() ?>/report/daftar_analisa_semua">
                <i class="fa fa-male"></i>
                <span>Daftar Analisa Indikator Mutu</span>
              </a>          
            </li>
            </ul>
          </section>
