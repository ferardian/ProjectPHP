  ...
  <div class="box box-primary">
    ...
    <div class="row" >
      <div class="col-md-12">
        ...
        <form role="form" method="POST" class="nilai" action="<?php echo site_url('report/post_inmut'); ?>" target="_blank">
          <div class="col-md-12">
            ...
            <div class="box-body with-border">
             ...
             <div class="form-group">
              ...
              <div class="row box-footer">
                <div class="col-md-12">
                  <div class="col-md">
                    <button  type="submit" name="submit1"  class="btn btn-primary btn-sm pull-right">Cetak Total</button>
                    <button  type="submit" name="submit2"  class="btn btn-primary btn-sm pull-right">Cetak Detail</button>
                  </div>
                </div>
